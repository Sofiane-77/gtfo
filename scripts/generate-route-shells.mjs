...
const pages = [
  ...
  },
  {
    ...
    description:
      "Track your GTFO log progression and read all logs in one place through the website terminal. Mark collected logs, monitor completion and keep your progress organized with this GTFO Log Tracker.",
    keywords:
