    ...
    return (
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-4 px-4 sm:px-11 pb-24">
        <Helmet>
          ...
          <meta
            name="description"
            content="Track your GTFO log progression and read all logs in one place through the on-site terminal. Mark collected logs, monitor completion and keep your progress organized."
          />
          <meta
            name="keywords"
            content="gtfo progress, gtfo log tracker, gtfo logs, gtfo log progression, gtfo player.log parser, gtfo log viewer, gtfo read all logs, achievement_readalllogs, D-Lock Block Decipherer, D-Lock Block Decipherer achievement, gtfo tools, track gtfo logs, gtfo log checklist"
          />
          <link
            rel="canonical"
            href="https://sofiane-77.github.io/gtfo/logs/"
          />
          <meta
            property="og:url"
            content="https://sofiane-77.github.io/gtfo/logs/"
          />
